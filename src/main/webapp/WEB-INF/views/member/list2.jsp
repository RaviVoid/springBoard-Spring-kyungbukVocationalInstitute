			...
			<div class="col-md-12">
				<div class="widget p-lg">
					...
					<table class="table table-hover">
						<thead>
							<tr><th>#번호</th><th>회원명</th><th>가입일</th></tr>
						</thead>
						<c:forEach items="${list}" var="member">
						<tr>
							<td>${member.num}</td><td><a href="get?num=${member.num}">${member.uname}</a></td><td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${member.joindate}"/></td>
						</tr>
						</c:forEach>
					</table>
